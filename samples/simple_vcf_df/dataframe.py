...
reader = VCFReader(vcf="/home/jdaw/s3-parliament-somatic-variant-calling/Set1/Strelka/strelka/variants/somatic.vcf.gz", bams=[], require_genotype=False, tag="strelka", info_keys=["*"], filter_keys=["*"], format_keys=["*"], regions=None, num_threads=16)
